...
import { tcro, mim } from "../../../helpers/tokens";
...
import { wtcro } from "../../../helpers/bond";
...
function Zapin({ open, handleClose, bond }: IZapinProps) {
    ...
    let defaultToken = tokens.find(token => token.name === tcro.name);
    ...
    const setMax = () => {
        ...
        let amount: any = Math.min(maxBondPriceToken, token.isTcro ? token.balance * 0.99 : token.balance);
