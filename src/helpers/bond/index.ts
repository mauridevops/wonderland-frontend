...
import { StableBondContract, LpBondContract, WtcroBondContract, StableReserveContract, LpReserveContract } from "../../abi";
...
export const wtcro = new CustomBond({
    name: "wtcro",
    displayName: "wTCRO",
    bondToken: "TCRO",
    bondIconSvg: TcroIcon,
    bondContractABI: WtcroBondContract,
    reserveContractAbi: StableReserveContract,
    networkAddrs: {
        [Networks.TCRO]: {
...
export default [mim, wtcro, mimTime, tcroTime];
